...
<p class="mb-4 leading-relaxed">This Privacy Policy is a legally binding document between you and Cosmic Nidhi (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the &ldquo;I accept&rdquo; tab or by use of the website or by other means) and will govern the relationship between you and Cosmic Nidhi for your use of the website &ldquo;Website&rdquo; (www.cosmicnidhi.in).</p>
...
<div class="mt-10 pt-6 border-t border-[#5A0E14]/15 text-sm text-[#6B3A2A]/80 font-medium">
  ...
  },
  {
    ...
    slug: 'return-policy',
    content: `<h2 class="text-2xl font-bold mb-4 text-[#3C080D]">Introduction</h2>
<p class="mb-4 leading-relaxed">The terms &ldquo;We&rdquo; / &ldquo;Us&rdquo; / &ldquo;Our&rdquo; / &ldquo;Company&rdquo; individually and collectively refer to Cosmic Nidhi and the terms &ldquo;Visitor&rdquo; / &ldquo;User&rdquo; refer to the users. This page states the Terms, Conditions, and Return Policies under which you (Visitor) may visit and make purchases on this website (&ldquo;www.cosmicnidhi.in&rdquo;). Please read this page carefully. If you do not accept the Terms and Conditions stated here, we would request you to exit this site.</p>
