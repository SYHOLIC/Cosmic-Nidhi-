...
import { Phone, Mail, MapPin, Globe, X, Sparkles, ExternalLink } from "lucide-react";
  ...
  return (
    <>
      <aside
        ...
        className="fixed bottom-6 right-5 sm:bottom-7 sm:right-7 z-50 flex flex-col items-end gap-2.5 pointer-events-auto select-none"
      >
        {/* ==============================================================
