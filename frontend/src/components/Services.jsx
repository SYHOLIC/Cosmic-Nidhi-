...
const SERVICES = [
  {
    ...
    whatWeExplore: [
      ...
      { title: 'Corporate Numerology', desc: 'Align Your Business Identity with the Power of Numbers.' },
      { title: 'Bank Account Number Analysis', desc: 'Decode Your Bank Account Number. Understand Its Numerological Influence.' },
