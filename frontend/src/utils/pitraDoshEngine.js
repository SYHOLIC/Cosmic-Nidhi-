...
export const CITIES_DATABASE = [
  ...
  { name: 'Kashi, Uttar Pradesh, India', lat: 25.3176, lng: 82.9739, tz: 5.5 },
  { name: 'Ayodhya, Uttar Pradesh, India', lat: 26.7922, lng: 82.1998, tz: 5.5 },
  { name: 'Mathura, Uttar Pradesh, India', lat: 27.4924, lng: 77.6737, tz: 5.5 },
  { name: 'Vrindavan, Uttar Pradesh, India', lat: 27.5807, lng: 77.7006, tz: 5.5 },
  ...
  { name: 'Gwalior, Madhya Pradesh, India', lat: 26.2183, lng: 78.1828, tz: 5.5 },
  { name: 'Jabalpur, Madhya Pradesh, India', lat: 23.1815, lng: 79.9864, tz: 5.5 },
  { name: 'Chandigarh, India', lat: 30.7333, lng: 76.7794, tz: 5.5 },
  { name: 'Surat, Gujarat, India', lat: 21.1702, lng: 72.8311, tz: 5.5 },
  { name: 'Vadodara, Gujarat, India', lat: 22.3072, lng: 73.1812, tz: 5.5 },
  { name: 'Rajkot, Gujarat, India', lat: 22.3039, lng: 70.8022, tz: 5.5 },
  { name: 'Nagpur, Maharashtra, India', lat: 21.1458, lng: 79.0882, tz: 5.5 },
  { name: 'Nashik, Maharashtra, India', lat: 19.9975, lng: 73.7898, tz: 5.5 },
  { name: 'Thane, Maharashtra, India', lat: 19.2183, lng: 72.9781, tz: 5.5 },
  { name: 'Navi Mumbai, Maharashtra, India', lat: 19.0330, lng: 73.0297, tz: 5.5 },
  ...
  { name: 'Jalandhar, Punjab, India', lat: 31.3260, lng: 75.5762, tz: 5.5 },
  { name: 'Ranchi, Jharkhand, India', lat: 23.3441, lng: 85.3096, tz: 5.5 },
  { name: 'Jamshedpur, Jharkhand, India', lat: 22.8046, lng: 86.2029, tz: 5.5 },
  { name: 'Bhubaneswar, Odisha, India', lat: 20.2961, lng: 85.8245, tz: 5.5 },
  { name: 'Puri, Odisha, India', lat: 19.8135, lng: 85.8312, tz: 5.5 },
  { name: 'Cuttack, Odisha, India', lat: 20.4625, lng: 85.8830, tz: 5.5 },
  ...
  { name: 'Meerut, Uttar Pradesh, India', lat: 28.9845, lng: 77.7064, tz: 5.5 },
  { name: 'Aligarh, Uttar Pradesh, India', lat: 27.8974, lng: 78.0880, tz: 5.5 },
  { name: 'Bareilly, Uttar Pradesh, India', lat: 28.3670, lng: 79.4304, tz: 5.5 },
  { name: 'Moradabad, Uttar Pradesh, India', lat: 28.8386, lng: 78.7733, tz: 5.5 },
  { name: 'Gorakhpur, Uttar Pradesh, India', lat: 26.7606, lng: 83.3732, tz: 5.5 },
  { name: 'Jodhpur, Rajasthan, India', lat: 26.2389, lng: 73.0243, tz: 5.5 },
  { name: 'Udaipur, Rajasthan, India', lat: 24.5854, lng: 73.7125, tz: 5.5 },
  { name: 'Kota, Rajasthan, India', lat: 25.2138, lng: 75.8648, tz: 5.5 },
  { name: 'Bikaner, Rajasthan, India', lat: 28.0229, lng: 73.3119, tz: 5.5 },
  { name: 'Ajmer, Rajasthan, India', lat: 26.4499, lng: 74.6399, tz: 5.5 },
  { name: 'Kochi, Kerala, India', lat: 9.9312, lng: 76.2673, tz: 5.5 },
  { name: 'Thiruvananthapuram, Kerala, India', lat: 8.5241, lng: 76.9366, tz: 5.5 },
  { name: 'Kozhikode, Kerala, India', lat: 11.2588, lng: 75.7804, tz: 5.5 },
  ...
  { name: 'Rameswaram, Tamil Nadu, India', lat: 9.2876, lng: 79.3129, tz: 5.5 },
  { name: 'Visakhapatnam, Andhra Pradesh, India', lat: 17.6868, lng: 83.2185, tz: 5.5 },
  { name: 'Vijayawada, Andhra Pradesh, India', lat: 16.5062, lng: 80.6480, tz: 5.5 },
  { name: 'Tirupati, Andhra Pradesh, India', lat: 13.6288, lng: 79.4192, tz: 5.5 },
  { name: 'Raipur, Chhattisgarh, India', lat: 21.2514, lng: 81.6296, tz: 5.5 },
  { name: 'Shimla, Himachal Pradesh, India', lat: 31.1048, lng: 77.1734, tz: 5.5 },
  { name: 'Jammu, Jammu and Kashmir, India', lat: 32.7266, lng: 74.8570, tz: 5.5 },
  { name: 'Srinagar, Jammu and Kashmir, India', lat: 34.0837, lng: 74.7973, tz: 5.5 },
  { name: 'Dubai, United Arab Emirates', lat: 25.2048, lng: 55.2708, tz: 4.0 },
  { name: 'Abu Dhabi, United Arab Emirates', lat: 24.4539, lng: 54.3773, tz: 4.0 },
  ...
  { name: 'Los Angeles, United States', lat: 34.0522, lng: -118.2437, tz: -8.0 },
  { name: 'Chicago, United States', lat: 41.8781, lng: -87.6298, tz: -6.0 },
  { name: 'Dallas, United States', lat: 32.7767, lng: -96.7970, tz: -6.0 },
  { name: 'Toronto, Canada', lat: 43.6532, lng: -79.3832, tz: -5.0 },
  { name: 'Vancouver, Canada', lat: 49.2827, lng: -123.1207, tz: -8.0 },
  { name: 'Singapore, Singapore', lat: 1.3521, lng: 103.8198, tz: 8.0 },
  { name: 'Sydney, Australia', lat: -33.8688, lng: 151.2093, tz: 10.0 },
  { name: 'Melbourne, Australia', lat: -37.8136, lng: 144.9631, tz: 10.0 },
  { name: 'Kathmandu, Nepal', lat: 27.7172, lng: 85.3240, tz: 5.75 },
  { name: 'Kuala Lumpur, Malaysia', lat: 3.1390, lng: 101.6869, tz: 8.0 },
  { name: 'Doha, Qatar', lat: 25.2854, lng: 51.5310, tz: 3.0 },
  { name: 'Riyadh, Saudi Arabia', lat: 24.7136, lng: 46.6753, tz: 3.0 }
];
